  ...
  <div>
    <el-row>
      <el-col class="padding-right-20">
        <span class="big-title">产品手册</span>
      </el-col>
      <div class="padding-top-50">
        <el-row>
          <el-col :span="24" v-for="(item,index) in manualFile" :key="item.text" class="margin-bottom-10">
        ...
        manualFile: [
          {
            ...
            text: '博世学堂_博世制动产品手册',
            file: require('../../assets/files/博世学堂_博世制动产品手册.pdf'),
          },
        ],
      }
    },
      ...
      canDownload(file){
        if (!!this.userInfo) {
          ...
          this.$confirm('必须登录才能下载,是否登录?', '提示', {
            ...
            this.$router.push({name: 'login', query: {path: 'bosch-school/bosch-school-manual'}})
          }).catch(() => {
            console.log('000')
          });
        }
